...
public class Working_With_A3 {
	public static void main(String[] args) throws InterruptedException {
		...
		System.out.println(driver.findElement(By.id("pollanswers-2")).isSelected());
		...
		System.out.println(driver.findElement(By.id("pollanswers-4")).isSelected());		
		Thread.sleep(2000);
		driver.findElement(By.id("vote-poll-1")).click();
		Thread.sleep(1000);
		System.out.println(driver.findElement(By.id("block-poll-vote-error-1")).getText());
		Thread.sleep(2000);
		driver.close();
	}
}
